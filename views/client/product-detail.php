            ...
            <div class="tab-container">
                ...
                <div id="tab2" class="tab-content">
                    ...
                    <p>Sau khi quý khách thanh toán đơn hàng sẽ nhận được mã QR code gửi về qua email đăng ký. Quý khách
                        có thể quét mã QR để theo dõi đơn hàng nhanh hơn.</p>
                    <div class="policy-container">
                        <div class="policy-special">
                            <strong class="orange">1. Mua sản phẩm Smartband được bảo hành như thế nào?</strong>
                            <div class="ask">
                                Để đảm bảo quyền lợi của quý khách hàng khi mua sản phẩm tại các cửa hàng thuộc hệ thống
                                cửa hàng Smartband. Chúng tôi cam kết tất cả các sản phẩm được tuân theo các điều khoản
                                ...
                                bảo hành máy tại các cửa hàng Smartband trên toàn quốc cũng như các trung tâm bảo hành
                                chính hãng sản phẩm.
                            </div>
                            <div class="ask">
                        ...
                        <div class="policy-special">
                            <strong class="orange">2. Mua sản phẩm tại Smartband có được đổi trả không? Nếu được thì phí
                                đổi trả sẽ được tính như thế nào?</strong>
                            <div class="ask">
                                Đối với các sản phẩm ĐTDĐ, MTB, MTXT, SMARTWATCH (Áp dụng bao gồm các sản phẩm Apple),
                                sản phẩm cùng model, cùng màu, cùng dung lượng. Trong tình huống sản phẩm đổi hết hàng,
                                khách hàng có thể đổi sang một sản phẩm khác tương đương hoặc cao hơn về giá trị so với
                                sản phẩm lỗi. Trường hợp khách hàng muốn trả sản phẩm: Smartband sẽ kiểm tra tình trạng
                        ...
                        <div class="policy-special">
                            <strong class="orange">
                                3. Smartband có chính sách giao hàng tận nhà không? Nếu giao hàng tại nhà mà không ưng
                                sản phẩm có được trả lại không?
                            </strong>
                            <div class="ask">
                                Smartband cam kết giao hàng toàn bộ 63 tỉnh thành, Smartband nhận giao đơn hàng có thời
                                ...
                                Smartband sẽ tư vấn chi tiết về cách thức giao nhận thuận tiện nhất.
                            </div>
                            <div class="ask">Nếu quý khách hàng không ưng ý với sản phẩm khi nhận hàng, quý khách có thể
                            ...
                            <div class="ask">
                                ...
                                giá trị sản phẩm. Nếu không ưng, Smartband sẽ hỗ trợ đổi sản phẩm cho khách hàng theo
                                chính sách đổi trả.
                            </div>
                            <div class="ask">
                        ...
                        <div class="policy-special">
                            ...
                            <div class="ask">Nếu bạn đã là hội viên của chương trình này, bạn sẽ được hưởng ưu đãi trả
                                thẳng giảm 3% khi mua sản phẩm. Để được trả góp bạn phải đủ 8 tháng công tác tại doanh
                                nghiệp.</div>
                            <div class="ask">Để biết thêm thông tin chi tiết. Quý khách vui lòng truy cập vào đường link
                                bên dưới</div>
                        </div>
                    </div>
                </div>
